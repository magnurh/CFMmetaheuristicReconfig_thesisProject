...
public class RandomAttributedFMGenerationTest {
	...
	public static void main(String[] args) throws Exception, BettyException {
		...
		characteristics.setPercentageCTC(10); // Percentage of cross-tree
												// constraints.
		
        //characteristics.setProbabilityMandatory(0);
        //characteristics.setProbabilityOptional(0);
        //characteristics.setProbabilityAlternative(40);
        //characteristics.setProbabilityOr(40);
		...
		writer.saveFM(afm, "././TestRun_attributedModel.afm");
		AttributedReader reader = new AttributedReader();
		VariabilityModel fm = reader.parseFile("./TestRun_attributedModel.afm");
