...
public class RandomFMGeneration1 {
	...
	public static void main(String[] args) throws Exception, BettyException {
		...
		characteristics.setPercentageCTC(10);			// Percentage of cross-tree constraints.
		
        //characteristics.setProbabilityMandatory(0);
        //characteristics.setProbabilityOptional(0);
        //characteristics.setProbabilityAlternative(0);
        //characteristics.setProbabilityOr(0);
		...
		writer.saveFM(fm, "./TestRun_normalModel.afm"); // Other valid formats: .splx, .fm, .dot
